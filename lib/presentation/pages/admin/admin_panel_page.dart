...
class _AdminPanelPageState extends State<AdminPanelPage>
  ...
  Future<_AdminDashboardStats> _loadDashboardStats() async {
    ...
    final applications = await _dataSource.getAllApplications();
    ...
    for (final app in applications) {
      ...
      // Count payments from pending/approved applications, but not rejected ones.
    ...
    return _AdminDashboardStats(
      ...
      processedApplications: _processed.length,
  ...
  Widget _buildApplicationsChart(_AdminDashboardStats stats) {
    final maxValue = [
  ...
  Widget _buildDashboardBreakdown(_AdminDashboardStats stats) {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
